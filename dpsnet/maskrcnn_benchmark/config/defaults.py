...
_C.MODEL.BACKBONE.FUSE_FPN = False
...
# ---------------------------------------------------------------------------- #
# Density Head Options
# ---------------------------------------------------------------------------- #
_C.MODEL.DENSITY_HEAD = CN()
_C.MODEL.DENSITY_HEAD.NUM_CLASSES = 1
_C.MODEL.DENSITY_HEAD.FPN_LEVEL = 1  # (p2, p3, p4, p5, p6), 1 for p3
_C.MODEL.DENSITY_HEAD.FPN_LEVEL_STRIDE = 1.0 / 8
_C.MODEL.DENSITY_HEAD.INTERPOLATE_MODE = 'bilinear'
...
_C.SOLVER.CROSS_TRAIN_STEPS = 10
_C.SOLVER.CROSS_TRAIN_DATA_RATIO = 0
_C.SOLVER.ITER_PER_STEP = 10000
...
_C.TEST.PSEUDO_LABELS_ANN_FILE = ''
_C.TEST.TEST_IMAGES_DIR = '/data/wedward/RPC_dataset/test2019/'
_C.TEST.TEST_ANN_FILE = '/data/wedward/RPC_dataset/instances_test2019.json'
_C.TEST.USE_GROUND_TRUTH = False
# Number of images per batch
# This is global, so if we have 8 GPUs and IMS_PER_BATCH = 16, each GPU will
# see 2 images per batch
