...
if __name__ == '__main__':
    ...
    parser.add_argument('--ann_file', type=str, default='/data/jianzh/instances_train2019.json')
    parser.add_argument('--images_dir', type=str, default='/data/jianzh/train2019')
    ...
    output_dir = '/data/jianzh/extracted_masks/masks'
    compare_dir = '/data/jianzh/extracted_masks/masked_images'
